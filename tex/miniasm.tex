...
adjacency is $w$-consistent, if (i) ${\rm utg}_i={\rm utg}_j$ and $|{\rm
...
applied the method in Section~\ref{sec:eval}. Except ERS473430, the miniasm is
consistent with the reference assemblies. For ERS473430, the NCTC project page
